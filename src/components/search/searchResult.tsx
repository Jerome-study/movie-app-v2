...
import { viewPerson, viewShow } from "../../utils/utils"
    ...
    return(
        <>
            {(result?.poster_path  || result.profile_path) &&
                <div className="col-6 col-sm-4 col-lg-3 col-xl-2" onClick={() => category === "person"? viewPerson(result, navigate): viewShow(result, navigate)}>
