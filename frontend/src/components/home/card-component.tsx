        ...
        <>
           {(movie.poster_path || movie.backdrop_path) && 
                <Card className="flex-shrink-0 border shadow-sm p-1 card-width" onClick={() => viewShow(movie, navigate )} >
                    <Card.Img className="rounded-0 rounded-top shadow-sm h-75" src={movie.poster_path? imageUrl + (movie.poster_path || movie.backdrop_path): 'corrupt.jpg'} alt="Card image"  />
