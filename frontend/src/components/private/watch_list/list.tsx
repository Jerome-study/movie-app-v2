            ...
            <>
                    ...
                    {loaded && 
                        <Card className="bg-dark text-white search-result-card rounded-0 position-relative h-100" style={{backgroundColor: "#eee"}} >
                            <Card.Img onClick={() => viewShowFromWatchList(movie, movie?.category)} className="h-100 rounded-0" src={import.meta.env.VITE_IMG_URL_POSTER + (movie?.poster_path)} alt="Card image" />
